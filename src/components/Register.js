...
function Register({ setUser }) {
    ...
    const onSubmit = async (e) => {
        e.preventDefault();
        try {
            const res = await axios.post('https://emailxp-backend-production.up.railway.app/api/users/register', formData);
            // Assuming the backend sends back the user object with a token
